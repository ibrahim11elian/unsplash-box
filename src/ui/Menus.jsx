...
function Toggle({ id }) {
  ...
  return (
    <button
      onClick={handleClick}
      className="translate-x-2 rounded-sm border-none bg-none p-1 text-2xl text-gray-800 transition-all duration-200 hover:bg-gray-100 focus:ring-2 focus:ring-gray-300"
    >
      <HiEllipsisVertical />
    </button>
  );
