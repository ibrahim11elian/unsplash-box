...
const StyledModal = React.forwardRef(function styledModal(props, ref) {
  return (
    <div
      ref={ref}
      className="fixed left-1/2 top-1/2 w-[95%] -translate-x-1/2 -translate-y-1/2 transform rounded-lg bg-white p-3 shadow-lg transition-all duration-500 sm:w-auto sm:p-8"
    >
      {props.children}
    </div>
  );
